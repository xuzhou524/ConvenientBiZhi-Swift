...
static const CGFloat kCard_Margin = 8.0f;
...
- (void)viewInitialAnimation
{
    ...
    __weak YSLDraggableCardContainer *weakself = self;
    view.alpha = 1.0;
    view.transform = CGAffineTransformScale(CGAffineTransformIdentity,0.25f,0.25f);
    [UIView animateWithDuration:0.1
                     ...
                     completion:^(BOOL finished){
                         [UIView animateWithDuration:0.1
                                          ...
                                          animations:^{
                                              view.transform = CGAffineTransformScale(CGAffineTransformIdentity,0.75f,0.75f);
                                          }
                                          completion:^(BOOL finished) {
                                              [UIView animateWithDuration:0.1
                                                                    delay:0.01
